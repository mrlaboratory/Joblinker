                    ...
                    <div>
                        <div className='p-8 bg-gradient-to-r  from-[#7e8ffe10] to-[#9873ff10] rounded-lg'>
                            ...
                            <div className='text-[#474747] pt-3'>
                                ...
                                <p className='flex items-center text-xl' > <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-1 text-[#7E90FE]">
